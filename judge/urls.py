...
urlpatterns = [
    ...
    path('update-name-dob/<slug:id>/', views.NameDOBUpdateView.as_view(), name='update_name_dob'),
    ...
    path('update-crop-image/<slug:id>/', views.CropImageUpdateView.as_view(), name='update_crop_image'),
